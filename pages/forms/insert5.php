...
<head>
    ...
    <title>Cricket League Tournament | Venue</title>
                            ...
                            <div class="col-lg-6 m-auto">
                                ...
                                <div class="card">
                                    <div class="card-header bg-dark">
                                        <h1 class="text-white text-center">Venue</h1>
                                    </div><br>
                                    ...
                                    <form action="upload4.php" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name" name="match" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Venue:</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name" name="venue" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Results:</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name" name="results" required>
                                            </div>
