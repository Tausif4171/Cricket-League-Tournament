    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
        ...
        <main class="container">
            ...
            <nav aria-label="breadcrumb" id="team0" style="background-color: white; width: 367px;">
                <ol class="breadcrumb" style="background-color: white;">
                <li class="breadcrumb-item"><img src="image/Afghanistan_Flag.png" alt="" id="team0_1" /></li>
                    <li aria-current="page" style="font-size:24px;  margin-top: 35px;margin-left:22px;">Afghanistan</li>
                </ol>
            </nav>
