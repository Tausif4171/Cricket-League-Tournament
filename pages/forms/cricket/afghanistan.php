    ...
    <div style="overflow: hidden;">
        ...
        <main class="container">
            ...
            <nav aria-label="breadcrumb" id="team0" style="background-color: white;">
                ...
                <a href="details.php"><li class="breadcrumb-item"><img src="image/Afghanistan_Flag.png" alt="" id="team0_1" /></li></a>
                    <a href="details.php"><li aria-current="page" style="font-size:24px;  margin-top: 35px;margin-left:22px;">Afghanistan</li></a>
                </ol>
            </nav>
