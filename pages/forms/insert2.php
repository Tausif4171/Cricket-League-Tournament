          ...
          <form action="" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="looser" id="exampleInputEmail1"
                        placeholder="Enter Looser" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Man of the Match:</label>
                      <input type="text" class="form-control" name="man_of_match" id="exampleInputEmail1"
                        placeholder="Enter Man of the Match" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Bowler of the Match:</label>
                      <input type="text" class="form-control" name="bowler_of_match" id="exampleInputEmail1"
                        placeholder="Enter Bowler of the Match" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Best Fielder:</label>
                      <input type="text" class="form-control" name="best_fielder" id="exampleInputEmail1"
                        placeholder="Enter Best Fielder" required>
                    </div>
